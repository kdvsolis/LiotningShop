using LiotningShop.Areas.Admin.Models.ViewModels.Shop;
using LiotningShop.Models.Data;
using LiotningShop.Models.ViewModels.Shop;
using PagedList;
using System;
    ...
    public class ShopController : Controller
    {
        ...
        public ActionResult EditProduct(int id)
        {
            ...
            using (Db db = new Db())
            {
                ...
                model.Categories = new SelectList(db.Categories.ToList(), "Id", "Name");
                string x = Server.MapPath("~/Images/Uploads/Products/" + id.ToString() + "/Gallery/Thumbs");
